...
parser.add_argument('-m', '--max_result', type=int, default=10, required=False, help='Specify the JSON format file generated by zeek')
...
if __name__ == "__main__":
    ...
    if max_result > len(result):
        max_range = len(result)
    else:
        max_range = max_result
    print(f"# Top {max_range} Source IP addresses")
    ...
    if max_result > len(result):
        ...
        max_range = max_result
    print(f"# Top {max_range} domains. 2nd level")
    for _ in range(0,max_range):
        print(result[counter])
        counter -= 1
    print("")
    ...
    if max_result > len(result):
        ...
        max_range = max_result
    print(f"# Top {max_range} domains. 3rd level")
    for _ in range(0,max_range):
        print(result[counter])
        counter -= 1
    print("")